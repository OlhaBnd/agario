...
def handle_data():
    ...
    while True:
        ...
        # Перевіряємо зіткнення між гравцями
        eliminated = []
        ...
        # Відправляємо дані або повідомлення про смерть
...
while True:
    try:
        ...
        id_counter += 1
        new_id = id_counter
        players[conn] = {'id': new_id, 'x': 0, 'y': 0, 'r': 20}
        conn_ids[conn] = new_id
        conn.send(f"{new_id},0,0,20".encode())
    except:
        pass
